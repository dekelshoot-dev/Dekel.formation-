...
export const PREDEFINED_TEMPLATES: CustomEmailTemplate[] = [
  ...
  <div style="padding: 32px 24px; color: #1e293b; line-height: 1.6;">
    ...
    <div style="text-align: center; margin-top: 32px;">
      <a href="https://dekel-formation.com" style="display: inline-block; background: #4f46e5; color: #ffffff; font-weight: 700; text-decoration: none; padding: 14px 28px; border-radius: 12px; box-shadow: 0 4px 12px rgba(79, 70, 229, 0.3);">
  ...
  <div style="padding: 32px 24px; color: #334155; line-height: 1.6;">
    ...
    <div style="text-align: center; margin-top: 28px;">
      <a href="https://dekel-formation.com" style="display: inline-block; background: #0284c7; color: #ffffff; font-weight: 700; text-decoration: none; padding: 12px 24px; border-radius: 10px;">
  ...
  <div style="padding: 32px 24px; color: #334155; line-height: 1.6;">
    ...
    <div style="text-align: center; margin: 32px 0;">
      <a href="https://dekel-formation.com" style="display: inline-block; background: #d97706; color: #ffffff; font-weight: 700; text-decoration: none; padding: 14px 28px; border-radius: 12px; box-shadow: 0 4px 12px rgba(217, 119, 6, 0.3);">
  ...
  <div style="padding: 32px 24px; color: #334155; line-height: 1.6;">
    ...
    <div style="text-align: center; margin-top: 28px;">
      <a href="https://dekel-formation.com" style="display: inline-block; background: #e11d48; color: #ffffff; font-weight: 700; text-decoration: none; padding: 14px 28px; border-radius: 12px;">
        Profiter de l'offre
      </a>
    </div>
  </div>
